...
/**
  ...
  Stack Pointer Limit  hence zero is returned always in non-secure
  mode.
...
/**
  ...
  Devices without ARMv8-M Main Extensions (i.e. Cortex-M23) lack the non-secure
  Stack Pointer Limit  hence zero is returned always.
...
/**
  ...
  Devices without ARMv8-M Main Extensions (i.e. Cortex-M23) lack the non-secure
  Stack Pointer Limit  hence the write is silently ignored in non-secure
  mode.
...
/**
  \brief   Set Process Stack Pointer (non-secure)
  Devices without ARMv8-M Main Extensions (i.e. Cortex-M23) lack the non-secure
  Stack Pointer Limit  hence the write is silently ignored.
